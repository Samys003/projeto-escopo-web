          ...
          <form className="space-y-5">
            <div>
              <input
                ...
                className="w-full px-4 py-4 border-2 border-gray-300 rounded-3xl focus:outline-none focus:border-purple-600 text-gray-700 placeholder:text-gray-400 transition"
              />
            </div>
